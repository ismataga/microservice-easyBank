...
public class CustomerServiceImpl implements CustomersService {
    ...
    @Override
    public CustomerDetailsDto fetchCustomerDetails(String corelationId,String mobileNumber) {
        ...
        ResponseEntity<CardsDto> cardsDtoResponseEntity = cardsFeignClient.fetchCardDetails(corelationId,mobileNumber);
