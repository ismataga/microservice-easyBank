...
import com.ismataga.accounts.dto.AccountsMessageDto;
...
public class AccountServiceImpl implements AccountService {
    ...
    public void createAccount(CustomerDto customerDto) {
        ...
        if (optionalCustomer.isPresent()) {
            throw new CustomerAlreadyExistsException("Customer with the same mobile number already exists."
                    + customer.getMobileNumber());
        }

        Customer saveCustomer = customerRepository.save(customer);
        Accounts savedAccounts =accountsRepository.save(createNewAccount(saveCustomer));
